...
<div id="contact" class="content">
    <div class="full-img" id="img-contact"><!--<div></div>--></div>

    <div class="w1280">
        <div>
            <h1>Contactez-nous</h1>
            <p>Via le formulaire de contact ci-dessous ou par téléphone.</p>
...
</label><label id="msg"> Message* <span class="wpcf7-form-control-wrap message"><textarea name="message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></textarea></span><br>
